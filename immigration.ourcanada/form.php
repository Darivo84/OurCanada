...
if (!isset($_COOKIE['Lang'])) {
    ...
    if ($_COOKIE["Lang"] != 'english') {
        $old_lang = $_COOKIE["Lang"] == '' ? 'english' : $_COOKIE["Lang"];
        setcookie("Lang", "english");
        setcookie("oldLang", $old_lang);
        header('Location: ' . $_SERVER['REQUEST_URI']);
    }
} else if (isset($_GET["Lang"]) && $_GET["Lang"] != '') {
    $lang = $_GET['Lang'];
    $old_lang = $_COOKIE["oldLang"];
    if ($_COOKIE["Lang"] !== $_COOKIE["oldLang"]) {
        $old_lang = $_COOKIE["Lang"] == '' ? 'english' : $_COOKIE["Lang"];
    }

    if ($old_lang == $_GET["Lang"]) {
        $old_lang = $_COOKIE['oldLang'];
    }
    $trans=$lang;
    if($trans=='francais')
                    ...
                    <div class="card login-signup-card shadow-lg mb-0">
                        <div class="card-body px-md-5 py-5">
                            <div class="mb-5">
                                ...
                                <p class="text-muted mb-0 static_label">Please start completing our dynamic form and find out which Canadian immigration programs you may qualify for</p>
                            </div>
                            ...
                            <form class="login-signup-form quesCreate myForm" id="validateform">
                                ...
                                <div class="formDiv">
                                    ...
                                    while ($row = mysqli_fetch_assoc($getQuestions)) {
                                        ...
                                        // Translation Check
                                        if ($trans !== '') {
                                            if ($row['question_french'] !== '' && $row['question_french'] !== null && $row['question_urdu'] !== '' && $row['question_urdu'] !== null) {
                                                $row['question'] = $row['question_'.$trans];
                                            }
                                            if ($row['notes_french'] !== '' && $row['notes_french'] !== null && $row['question_urdu'] !== '' && $row['notes_urdu'] !== null) {
                                                $row['notes'] = $row['notes_'.$trans];
                                            }
                                        }
                                        ?>
                                        <div class="main_parent_<?php echo $row['id'] ?> parent_question">
                                            <div class="form-group main_question_div"
                                                 id="question_div_<?php echo $row['id'] ?>">
                                                <label class="pb-1"><?php echo $row['question']; ?></label>
                                                ...
                                                <div class="input-group input-group-merge <?php echo $permission ?>">
                                                    ...
                                                    <?php if ($fldArr[$row['fieldtype']]['type'] == 'calender') { ?>
                                                        <input type="text" class="form-control datepicker"
                                                               name="n[question_<?php echo $row['id']; ?>]" <?php echo $row['validation']; ?>>
                                                    <?php } else if ($fldArr[$row['fieldtype']]['type'] == 'nocjob') { ?>
                                                        <div class="bs-example">
                                                            <input type="text" value=""
                                                                   class="<?php echo $row['validation']; ?> tagsInp form-control jobs"
                                                                   data-role="tagsinput" data-type="jobs"
                                                                   name="n[question_<?php echo $row['id']; ?>]" <?php echo $row['validation']; ?> >
                                                        </div>
                                                    <?php } else if ($fldArr[$row['fieldtype']]['type'] == 'nocduty') { ?>
                                                        <div class="bs-example">
                                                            <input type="text" value=""
                                                                   class="<?php echo $row['validation']; ?> tagsInp form-control duty"
                                                                   data-role="tagsinput" data-type="duty"
                                                                   name="n[question_<?php echo $row['id']; ?>]" <?php echo $row['validation']; ?> >
                                                        </div>
                                                    <?php } else if ($fldArr[$row['fieldtype']]['type'] == 'age') { ?>
                                                        <input type="text" class="form-control datepicker age"
                                                               name="n[question_<?php echo $row['id']; ?>]" <?php echo $row['validation']; ?>>
                                                        <input type="text" class="form-control dob" readonly hidden
                                                    ...
                                                    <?php } else if ($fldArr[$row['fieldtype']]['type'] == 'radio' && $row['labeltype'] == 0) { ?>
                                                        <input id="Yes_<?php echo $row['id'] ?>" type="radio"
                                                               class="radioButton"
                                                               name="n[question_<?php echo $row['id']; ?>]"
                                                               onClick="getQuestion(this,'<?php echo $row['id']; ?>')" <?php echo $row['validation']; ?>
                                                               value="Yes"><span class="customLabel">Yes</span>
                                                        <input id="No_<?php echo $row['id'] ?>" type="radio"
                                                               class="radioButton"
                                                               name="n[question_<?php echo $row['id']; ?>]"
                                                               onClick="getQuestion(this,'<?php echo $row['id']; ?>')"
                                                               value="No"><span class="customLabel">No</span>
                                                    <?php } else if ($fldArr[$row['fieldtype']]['type'] == 'radio' && $row['labeltype'] == 1) {
                                                        ...
                                                        while ($row_label = mysqli_fetch_assoc($getLabels)) {
                                                            ...
                                                            <input type="radio" class="radioButton"
                                                                   name="n[question_<?php echo $row['id']; ?>]"
                                                                   onClick="getQuestion(this,'<?php echo $row['id']; ?>')"
                                                                   value="<?php echo $row_label['value'] ?>" <?php echo $row['validation']; ?>>
                                                            <span class="customLabel"><?php echo $row_label['label'] ?></span>
                                                        <?php }
                                                    } else if ($fldArr[$row['fieldtype']]['type'] == 'dropdown') { ?>
                                                        <select name="n[question_<?php echo $row['id']; ?>]"
                                                                class="form-control"
                                                                onchange="getQuestion(this,'<?php echo $row['id']; ?>')" <?php echo $row['validation']; ?>>
                                                            <option value="" disabled selected class="static_label">--Select--</option>
                                                            <?php
                                                            $getLabels = mysqli_query($conn, "select * from question_labels where question_id={$row['id']} and label!='' ");
                                                            while ($row_label = mysqli_fetch_assoc($getLabels)) {
                                                                ?>
                                                                <option data-id="<?php echo $row_label['label'] ?>" value="<?php echo $row_label['value'] ?>"><?php echo $row_label['label'] ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    <?php } else if ($fldArr[$row['fieldtype']]['type'] == 'country') { ?>
                                                        <select name="n[question_<?php echo $row['id']; ?>]"
                                                                class="form-control countryCheck"
                                                                onchange="getQuestion(this,'<?php echo $row['id']; ?>')" <?php echo $row['validation']; ?>>
                                                            <option value="" disabled selected class="static_label">--Select--</option>
                                                            <?php
                                                            $getCountires = mysqli_query($conn, "select * from countries ");
                                                            $col='_'.$trans;
                                                            if($trans=='')
                                                            {
                                                                $col='';
                                                            ...
                                                            while ($row_label = mysqli_fetch_assoc($getCountires)) {
                                                                ...
                                                                <option data-id="<?php echo 'col-'.$col ?>" value="<?php echo $row_label['name'] ?>"><?php echo $row_label['name'.$col] ?></option>
                                                    ...
                                                    <?php } else if ($fldArr[$row['fieldtype']]['type'] == 'education') { ?>
                                                        <select name="n[question_<?php echo $row['id']; ?>]"
                                                            ...
                                                            while ($row_label = mysqli_fetch_assoc($getCountires)) {
                                                                ...
                                                                <option value="<?php echo $row_label['name'] ?>"><?php echo $row_label['name'.$col] ?></option>

                                                            <?php } ?>
                                                        </select>
                                                    <?php } else if ($fldArr[$row['fieldtype']]['type'] == 'phone') { ?>
                                                        <input type="tel" minlength="6" maxlength="15"
                                                               class="form-control"
                                                               name="n[question_<?php echo $row['id']; ?>]" <?php echo $row['validation']; ?>>
                                                    ...
                                                    <?php } else if ($fldArr[$row['fieldtype']]['type'] == 'currentrange') { ?>
                                                        <label class='pb-date static_label'>From</label><label
                                                                class='pb-date static_label'>To</label>
                                                        <input type="text" data-id="from"
                                                               class="nocPicker form-control datepicker"
                                                               name="n[question_<?php echo $row['id']; ?>]" <?php echo $row['validation']; ?>>
                                                        <input type="text" data-date="YYYY-MM-DD" data-id="to"
                                                               class="nocPicker form-control datepicker"
                                                               onchange="if(checkDate(this)) {getQuestion(this,'<?php echo $row['id']; ?>') }"
                                                               name="n[question_<?php echo $row['id']; ?>]" <?php echo $row['validation']; ?>>
                                                        <div class='presCheck'><input type='checkbox'
                                                                                      class='present_checkbox'
                                                                                      onchange='if(presentBox(this)==false){return false;}getQuestion3(this,"<?php echo $row['id']; ?>")'><span
                                                                    class='presentCheckbox static_label'>Present</span>
                                                        </div>
                                                    <?php } else { ?>
                                                        <input type="text" class="form-control"
                                                               onfocusout="getQuestion(this,'<?php echo $row['id']; ?>')"
                                                               name="n[question_<?php echo $row['id']; ?>]" <?php echo $row['validation']; ?>>
                                                    <?php } ?>
                                ...
                                <div class="row" id="iAgree">
                                    <div class="col-sm-12">
                                        <div class="form-group">

                                            <a href="terms.php" class="static_label">Terms & Conditions</a>

                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="terms">
                                                <label class="custom-control-label static_label" for="terms">I agree</label>
                                            </div>
                                ...
                                <div class="row terms" id="lastBox">


                                    <button class="btn btn-block secondary-solid-btn border-radius mt-4 mb-3 terms1 static_label"
                                            id="btnLoader">Submit</button>
                                </div>
                            ...
                            <button class="scroll-edit open static_label" data-toggle="modal" onclick="check_endCase()"
                                    data-target="#editModal" style="display: none">Edit</button>
                        </div>
...
<div class="modal fade" id="editModal" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body static_label" id="editLabel">Are you sure you want to edit ? Once you edit, scoring will re-initiate</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btnModal static_label" data-dismiss="modal">No</button>
                <button type="button" class="btn btn-primary btnModal2 static_label" id="yesBtn2">Yes</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-success urduCheckBox"><i class="fa fa-check"></i> <span id="subModalBody" class="static_label">Form has been Submitted</span></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btnModal static_label" data-dismiss="modal" hidden>No</button>
                <button type="button" class="btn btn-primary btnModal2 static_label" id="yesBtn1">Okay</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="commentModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group2" id="comment_box">
                            <label style="margin-bottom: 7px;" class="static_label">Comments (optional)</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btnModal static_label" data-dismiss="modal" hidden>No</button>
                <button type="button" class="btn btn-primary btnModal2 static_label" id="yesBtn3">Submit</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="endModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title static_label" id="exampleModalLabel">Congratulations</h5>
            </div>
            <div class="modal-body static_label" id="endBody">Thank You for your interest in Canada</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btnModal static_label" data-dismiss="modal">Ok</button>
...
<div class="modal fade" id="warningModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title static_label" id="exampleModalLabel">Warning</h5>
            </div>
            <div class="modal-body static_label">There was an error handling your request please try again.</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btnModal static_label" data-dismiss="modal">Ok</button>
                <!--                <button type="button" class="btn btn-primary">Save changes</button>-->
            </div>
...
<div class="modal fade" id="errorModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary static_label" id="yesBtn4">Ok</button>
                <button type="button" class="btn btn-primary btnModal3 static_label" id="noBtn4">Cancel</button>
                <button type="button" hidden class="btn btn-secondary static_label closeModal" data-dismiss="modal">No</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    let check_lang='<?php echo $_GET['Lang']; ?>'
    ...
    var loaded=false
    if((localStorage.getItem('AgreeCheck')!=='' && localStorage.getItem('AgreeCheck')!==null && localStorage.getItem('AgreeCheck')!==undefined))
    {
        if(url!==local_url && local_url!=='' && local_url!==undefined && local_url!==null)
        {
            if (confirm("If you want to change language, your previous form data will be lost")) {
                localStorage.setItem('url',url)
                localStorage.setItem('old_url',local_url)
                local_old_url=local_url
                document.cookie = 'Lang='+cookie_lang;
                loaded=true
                console.log(0)
                for (var key in localStorage)
                {
                    if(key=='Lang' || key == 'oldLang' || key=='url' || key=='old_url')
                    {
                        continue
                    }
                    else
    ...
    // if (localStorage.getItem('AgreeCheck') == 0  || url!==local_old_url) {
    //     // localStorage.removeItem('form_' + form_id)
    // }
    if ( url!==local_old_url || localStorage.getItem('AgreeCheck') == 0  || localStorage.getItem('AgreeCheck')==null || localStorage.getItem('AgreeCheck')==undefined) {
        if(loaded==true)
        {
            console.log(2)
            localStorage.removeItem('form_' + form_id)
            ...
            success: function (data) {
                ...
                else
                {
                    if (qID == 576) {
                        ...
                        {
                            $(fieldData).insertBefore('.parent_12810')
                        }
                    ...
                    else if(qID==544)
                    {
                        ...
                        {
                            $(fieldData).insertBefore('.parent_11580')
                        }
                        ...
                        success: function (data) {
                            ...
                            if (data.Success == 'ques') {
                                ...
                                if (lang !== 'english' && lang !== '') {
                                    com=data.question.comments_<?php echo $lang ?>
