...
<head>
    <?php include_once($incFolderName."/metatags.php"); ?>
        ...
        <link rel="canonical" href="https://immigration.ourcanada<?php echo $ext ?>/form<?php echo $langURL ?>" />
            ...
            $('#validateform').validate({
                ...
                submitHandler: function() {
                    ...
                    if (date_error == true || position_error == true) {
                        ...
                        let q_109=$('input[name="n[question_109]"]').eq(1).prop('checked')
                        let q_724=$('input[name="n[sub_question_724]"]').eq(1).prop('checked')

                        let q_574=$('input[name="n[question_574]"]').eq(1).prop('checked')
                        let q_383=$('input[name="n[sub_question_383]"]').eq(1).prop('checked')
                        ...
                        setTimeout(function() {
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    user_noc=data.user_noc
                                    spouse_noc=data.spouse_noc
                                    ...
                                    if (data.Success == 'ques') {
                                        ...
                                        if (lang !== 'english' && lang !== '') {
                                            com = data.question.comments_<?php echo $langType=='francais'?'french':$langType ?>
                                        ...
                                        saveForm();
                                        console.log("auto save submit call");
                                        $.toaster({
                                            priority: "success",
                                            title: error_title,
                                            message: error_msg,
