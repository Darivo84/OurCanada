    ...
    t.extend(t.fn, {
        validate: function (e) {
            if (this.length) {
                ...
                return i || (this.attr("novalidate", "novalidate"), i = new t.validator(e, this[0]), t.data(this[0], "validator", i), i.settings.onsubmit && (this.validateDelegate(":submit", "click", function (e) {
                    ...
                    function s() {
                        var s;
                        return !i.settings.submitHandler || (i.submitButton && (s = t("<input type='hidden'/>").attr("name", i.submitButton.name).val(i.submitButton.value).appendTo(i.currentForm)), i.settings.submitHandler.call(i, i.currentForm, e), i.submitButton && s.remove(), !1)
                    }
        ...
        attributeRules: function (e) {
            ...
            for (var r in t.validator.methods) {
                var n;
                "required" === r ? ("" === (n = s.get(0).getAttribute(r)) && (n = !0), n = !!n) : n = s.attr(r), n ? i[r] = n : s[0].getAttribute("type") === r && (i[r] = !0)
            }
