<script>
            ...
            currentRequest = $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.grade!=='' && data.grade!==null)
                    {
                        ...
                        {
                            if(spouseGrades !== null && spouseGrades.length > 0)
                            {
                                let ind=spouseGrades.indexOf(gr)
                                ...
                                {
                                    spouseGrades.push(gr)
                                }
                            }
                            else
                            {
                                spouseGrades = new Array()
                                spouseGrades.push(gr)
                            }
                ...
                if (date_pos == 'from' && (toDate == '' || toDate == undefined)) {
                    if (noc_user == 'spouse') {
                        if (nocSpouse.hasOwnProperty(index)) {
                            if(nocSpouse[index]!=='' && nocSpouse[index]!==null)
                        ...
                        if (nocUser.hasOwnProperty(index)) {
                            if(nocUser[index]!=='' && nocUser[index]!==null)
    ...
    {
        let after_sub=$('.afterSub').length
        let editDisp=$('.scroll-edit').css('display')
        if($('.main_parent_117').length > 0 )
        {
            let element=document.getElementsByName('n[question_117]')
            let check1=element[0].checked
            let check2=element[1].checked
