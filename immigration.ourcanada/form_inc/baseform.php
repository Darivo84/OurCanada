...
?><section class="promo-block<?php if($getLangUrl[1]!=='formapi') { ?> ptb-100 <?php } ?>">
...
<?php if (isset($_SESSION['user_id'])) {  ?>
    ...
    <div class="float-div" style="display: none;">
    ...
    <div class="float-div" id="mDraft" style="display: none;">
