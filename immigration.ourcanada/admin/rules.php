                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-bordered dt-responsive">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="min-width: 500px;">Number (how many?)</th>
...
<!--                                                        <th style="min-width: 120px;">Value</th>-->
                                                        ...
                                                        <th style="width: 5%">Status Operator</th>
                                                        <th style="width: 5%">Status</th>
                                                        <th style="width: 5%">Auth Operator</th>
                                                    ...
                                                    <tr id="nocRow" class="nocRow">
                                                        ...
                                                        <td>
                                                            <select data-live-search="true" class="form-control mult nocSelect"  multiple name="noc[region][1][]">
                                                                <option value="" selected></option>
                                                        ...
                                                        <td>
                                                            <select name="noc[authorization][1][]"  multiple
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered dt-responsive ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="width: 30%">Question/Score</th>
                                                        <th>Operator</th>
