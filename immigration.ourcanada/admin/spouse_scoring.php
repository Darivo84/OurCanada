                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <div id="grouped" class="optionsDiv" style="display: none">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered dt-responsive nowrap">
                                                    ...
                                                    <tr id="trCountttt" class="trCountttt">
                                                        <td>
                                ...
                                $getType = mysqli_query($conn, "SELECT * FROM score_questions2 WHERE score_id = '$getID'");
                                $typeRow = mysqli_fetch_assoc($getType);

                                $getConditions = mysqli_query($conn, "SELECT * FROM score_conditions WHERE score_id = {$row['id']}");
                                $getQues = mysqli_query($conn, "SELECT * FROM score_questions2 WHERE score_id = {$row['id']} and type='or'");
                                $getQues2 = mysqli_query($conn, "SELECT * FROM score_questions2 WHERE score_id = {$row['id']} and type='and'");
                                $getQues3 = mysqli_query($conn, "SELECT * FROM score_questions2 WHERE score_id = {$row['id']} and type='grouped'");
                                $getQues4 = mysqli_query($conn, "SELECT * FROM score_questions2 WHERE score_id = {$row['id']} and type='both' order by id asc");
                                $getQues5 = mysqli_query($conn, "SELECT * FROM score_ontype WHERE score_id = $getID");
                                $row6 = mysqli_fetch_assoc($getQues5);

                                $getQues6 = mysqli_query($conn, "SELECT * FROM score_questions2 WHERE score_id = {$row['id']} and type='existing'");
                                ...
                                <?php }
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive"
                                        ...
                                        while ($Row = mysqli_fetch_assoc($getQuery)) {
                                            $getScore = mysqli_query($conn, "SELECT * FROM score_questions2 WHERE score_id = '{$Row['id']}'");
...
<script>
    ...
    $(document).ready(function () {
        ...
        // $('.select2-container .select2-selection--single').css('pointer-events', 'none')
