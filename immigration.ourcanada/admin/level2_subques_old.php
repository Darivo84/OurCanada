                                    ...
                                    <form method="post" id="validateForm">
                                        ...
                                        <div id="email" class="optionsDiv">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <label>Send data with email ?</label>

                                                    <div class="form-group">
                                                        <div class="form-check" style="display: inline">
                                                            <input type="radio" class="form-check-input" value="1" id="materialUnchecked" name="n[is_email]">
                                                            <label class="form-check-label" for="materialUnchecked">Yes</label>
                                                        </div>

                                                        <!-- Material checked -->
                                                        <div class="form-check" style="display: inline">
                                                            <input type="radio" class="form-check-input" value="0" id="materialChecked" name="n[is_email]" checked>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control selectBox" name="s[casetype]" id="casetype" required onchange="changeOption()">
                                                        ...
                                                        <option value="age" <?php if($row2['casetype']=='age') echo 'selected';?>>Age Limit</option>
                                        ...
                                        <div id="email" class="optionsDiv">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-check" style="display: inline">
                                                            <input type="radio" class="form-check-input" value="1" id="materialUnchecked" name="n[is_email]" <?php if($row1['is_email']=='1') echo 'checked' ?>>
                                                            <label class="form-check-label" for="materialUnchecked">Yes</label>
                                                        </div>

                                                        <!-- Material checked -->
                                                        <div class="form-check" style="display: inline">
                                                            <input type="radio" class="form-check-input" value="0" id="materialChecked" name="n[is_email]" <?php if($row1['is_email']=='0') echo 'checked' ?>>
                                                            <label class="form-check-label" for="materialChecked">No</label>
                                                        </div>
                                                    </div>
                                                </div>
