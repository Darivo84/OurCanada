...
$scoreID = mysqli_query($conn, "SELECT * FROM global_rule where ruleID !='' order by id desc limit 1");
$sRow = mysqli_fetch_assoc($scoreID);
$scoreIDD = $sRow['scoreID'] + 1;

$getScores = mysqli_query($conn, "SELECT * FROM score order by cast(scoreID as DECIMAL(8,2)) asc");
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title mt-0" id="myModalLabel">Delete Rule</h5>
                            ...
                            <div class="card-body">
                                ...
                                if ($_GET['method'] == 'add') { ?>
                                    <form method="post" id="validateForm">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <label for="title">Rule ID</label>

                                                <div class="input-group mb-3">
                                                    <input type="number" id="scoreID" name="n[ruleID]"
                                                    ...
                                                    <tr id="trCounttttt1" class="trCounttttt">
                                                        ...
                                                        <td>
                                                            <select class="form-control" name="other[]"
                                                                ...
                                                                <option value="multicondition">Select Score IDs</option>
                                        ...
                                        <div id="multicondition" class="optionsDiv" style="display: none">
                                            <table class="table table-bordered dt-responsive nowrap">
                                                ...
                                                <tr id="trCount">
                                                    ...
                                                    <td>
                                                        <select name="c[value][]" class="form-control selectBox" required>
                                                            <option value="" selected disabled>-- Select --</option>
                                                            <?php
                                                            foreach ($getScores as $kV => $Vv) {
                                                                ?>
                                                                <option value="<?php echo $Vv['id'] ?>"><?php echo $Vv['scoreID'].' - '.$Vv['notes'] ?></option>
                                                                <?php
                                                            }
                                ...
                                $getID = $_GET['id'];
                                $r = '';
                                $getQuestion = mysqli_query($conn, "SELECT * FROM global_rule WHERE id = '$getID'");
                                $row = mysqli_fetch_assoc($getQuestion);

                                $getType = mysqli_query($conn, "SELECT * FROM global_rule_questions WHERE rule_id = '$getID'");
                                $typeRow = mysqli_fetch_assoc($getType);

                                $getConditions = mysqli_query($conn, "SELECT * FROM global_rule_conditions WHERE rule_id = {$row['id']}");
                                $getQues4 = mysqli_query($conn, "SELECT * FROM global_rule_questions WHERE rule_id = {$row['id']} order by id asc");
                                $row6 = mysqli_fetch_assoc($getQues5);

                                $getQues6 = mysqli_query($conn, "SELECT * FROM global_rule_questions WHERE score_id = {$row['id']} and type='existing'");
                                $row7 = mysqli_fetch_assoc($getQues6);


                                if ($row['noc'] == 1) {
                                    $getNoc = mysqli_query($conn, "SELECT * FROM global_rule_noc WHERE rule_id = $getID");
//                                    $nocRow=mysqli_fetch_assoc($getNoc);
                                    ...
                                    <form method="post" id="EvalidateForm">
                                                        ...
                                                        <tr id="trCounttttt<?php echo $i ?>" class="trCounttttt">
                                                            ...
                                                            <td>
                                                                <select class="form-control" name="other[]"
                                                                    ...
                                                                    <option value="multicondition" <?php if ($row5['condition2'] == '') echo 'selected' ?>>Select Score IDs</option>
                                                ...
                                                <div id="email" class="col-sm-12" <?php if ($ocase != 4) { ?> style="display: none;" <?php } ?>>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                                <input type="email" value="<?php echo $row5['email'] ?>" class="form-control" name="t[email]">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>Subject</label>
                                                                <input type="text" value="<?php echo $row5['subject'] ?>" class="form-control" name="t[subject]">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <label>Message</label>
                                                                <textarea rows="4" class="form-control" name="t[message]"><?php echo $row5['message'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="multicondition" class="optionsDiv">
                                            <table class="table table-bordered dt-responsive nowrap">
                                                ...
                                                <tbody id="appendQuesType">
                                                <?php $i=1; while($ids=mysqli_fetch_assoc($getConditions)) {
                                                    ?>
                                                    <tr id="trCount<?php echo $i ?>">
                                                        <td>
                                                            <select name="c[operator][]" class="form-control" required>
                                                                <option value="=" <?php if ($ids['operator'] == '=') echo 'selected'; ?>>Include</option>
                                                                <option value="!=" <?php if ($ids['operator'] == '!=') echo 'selected'; ?>>Exclude</option>
                                                            </select>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <select name="c[value][]" class="form-control selectBox" required>
                                                                ...
                                                                foreach ($getScores as $kV => $Vv) {
                                                                    ?>
                                                                    <option value="<?php echo $Vv['id'] ?>" <?php if ($Vv['id'] == $ids['value']) echo 'selected'; ?>><?php echo $Vv['scoreID'].' - '.$Vv['notes'] ?></option>
                                                                    <?php
                                                                }
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" name="n[notes]" value="<?php echo $row['notes'] ?>" id="notes_text"
                                                           class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php }
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive"
                                        ...
                                        <tbody>
                                        <?php
                                        $getQuery = mysqli_query($conn, "SELECT * FROM global_rule order by ruleID asc");

                                        $count = 1;
                                        while ($Row = mysqli_fetch_assoc($getQuery)) {
                                            $getScore = mysqli_query($conn, "SELECT * FROM global_rule WHERE rule_id = '{$Row['id']}'");
...
<script>
    ...
    function otherCase(e) {
        ...
        if (a == 'multicondition') {
            ...
            $('#multicondition').find('input, textarea, button, select').prop('disabled', false);



        } else {

            $('#multicondition').find('input, textarea, button, select').prop('disabled', true);
    ...
    $("#addMoreMulti").on('click', function () {
        ...
        var QuesHTML = '<tr id="trCount' + totalRowCount + '">' +
            '<td><select name="c[operator][]" class="form-control valid" required=""><option value="=">Include</option>\n' +
            '                                                            <option value="!=">Exclude</option></select></td>' +
            '<td> <select name="c[value][]" class="form-control selectBox" required>\n'+
            '                                                            <option value="" selected disabled>-- Select --</option>\n'+
            '                                                            <?php foreach ($getScores as $kV => $Vv) { ?> <option value="<?php echo $Vv['id'] ?>"><?php echo $Vv['scoreID']." - ".$Vv['notes'] ?></option>\n'+
            '                                                                <?php } ?>\n'+
            '                                                        </select></td>' +

            '<td><a href="javascript:void(0);" class="remove_button btn btn-danger"><i class="fa fa-trash"></i></a></td></tr>';
    ...
    $('#EvalidateForm').validate({
        submitHandler: function () {
            ...
            $.ajax({
                dataType: 'json',
                url: "ajax.php?h=updateRule",
                type: 'POST',
                data: $("#EvalidateForm").serialize(),
                success: function (data) {
                    $("#AddLoaderE").html('Update Rule');
    ...
    $("#delLoader").on('click', function () {
        ...
        $.ajax({
            dataType: 'json',
            url: "ajax.php?h=deleteRule",
            type: 'POST',
            data: {'id': id},
            success: function (data) {
                if (data.Success == 'true') {
                    $("#delLoader").html('Delete');
                    window.location.assign("/admin/global_rule");
                } else {
                    $("#delLoader").html('Delete Rule');
                    $(window).scrollTop(0);
                    $('.prompt').html('<div class="alert alert-danger" style="text-align:left !important"><i class="fas fa-times" style="margin-right:10px;"></i>' + data.Msg + '</div>');
                    setTimeout(function () {
                        $("div.prompt").hide();
