                                                    ...
                                                    <tr id="nocRow" class="nocRow">
                                                        ...
                                                        <td>
                                                            <select data-live-search="true" class="form-control mult nocSelect" data-id="region"  multiple name="noc[region][1][]">
                                                                ...
                                                                <option value="Timmins or Vernon">
                                                                    Timmins or Vernon
                                                                </option>
                                        ...
                                        <div id="multicondition" class="optionsDiv" style="display: none">
                                            <table class="table table-bordered dt-responsive nowrap">
                                                ...
                                                <tr id="trCount">
                                                    ...
                                                    <td>
                                                        <select name="c[value][]" class="form-control" required>
                                                            <option value="" selected disabled>-- Select --</option>
                                                            <?php
                                                            foreach ($getScores as $kV => $Vv) {
                                                                ?>
...
<script>
    ...
    $("#addMoreMulti").on('click', function () {
        ...
        var QuesHTML = '<tr id="trCount' + totalRowCount + '">' +
            '<td><select name="c[operator][]" class="form-control valid" required=""><option value="=">=</option><option value="!=">!=</option><option value="<">&lt;</option><option value=">">&gt;</option><option value="<=">&lt;=</option><option value=">=">&gt;=</option><option value="-">-</option> </select></td>' +
            '<td> <select name="c[value][]" class="form-control" required>\n'+
            '                                                            <option value="" selected disabled>-- Select --</option>\n'+
