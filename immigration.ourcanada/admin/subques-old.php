                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control selectBox" name="s[casetype]" id="casetype" required onchange="changeOption()">
                                                        ...
                                                        <option value="multicondition">Multi Conditon</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="noc" name="n[noc_number]" placeholder="123,657,876" style="display: none">
                                        ...
                                        <div id="subquestion" class="optionsDiv">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label for="title">NOC</label>
                                                        <input type="text" class="form-control" id="noc" name="n[noc_number]" placeholder="123,657,876" value="<?php echo $row1['noc_number']?>" <?php if($row1['casetype']!='existingcheck') { ?> style="display: none;" <?php } ?>>
