...
//                                if($_GET['method'] == 'edit')
                                ...
                                ?>
                                            ...
                                            $.ajax( {
                                                ...
                                                success: function ( data ) {
                                                    ...
                                                    if(data.data.field == 'radio' && data.data.labeltype == 0){
                                                        ...
                                                        fieldHTML += '<option '+sel+' value="None">None</option>';
                                                        $("#existValue2 select").append(fieldHTML); //Add field html
                                                        $("#existValue2").show();
                                                    }else{
                                    ...
                                    <form method="post" id="validateForm">
                                        <input type="hidden" name="n[question_id]" value="<?php echo $row1['question_id'] ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control selectBox" name="s[casetype]" id="casetype" required onchange="changeOption()">
                                                        ...
                                                        <option value="end" <?php if($row1['casetype']=='end') echo 'selected';?>>End</option>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-control custom-radio" style="display: inline">
                                                            <input type="radio" class="custom-control-input val_sep" id="noc1"
                                                                   name="n[val_separator]" value="0" checked  <?php if($row1['val_separator']==0) echo 'checked' ?>>
                                                            <label class="custom-control-label" for="noc1">No</label>
                                                        </div>
                                                        <div class="custom-control custom-radio" style="display: inline">
                                                            <input type="radio" class="custom-control-input val_sep" id="noc2"
                                                                   name="n[val_separator]" value="1"  <?php if($row1['val_separator']==1) echo 'checked' ?>>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="s_question" <?php if($fLabel['existing_sid']!=0 && $row1['casetype']=='multicondition') { ?> style="display: block" <?php } else { ?> style="display: none" <?php } ?>>
                                                                <select name="c[existing_sid][]" class="form-control selectBox" id="existing_sid" required="" onChange="checkAnswer(this,'s_question')" data-type="s_question">
                                                                    ...
                                                                    {
                                                                        ?>
                                                                        <option value="<?php echo $v['id']?>" <?php if($v['id']==$fLabel['existing_sid']) { echo 'selected' ;} ?>><?php echo $v['question'].' - '.$v['id'] ?></option>
                                                                        <?php
                                                                    }
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <br><br>
                                                        <div class="custom-control custom-radio" style="display: inline">
                                                            <input type="radio" class="custom-control-input grade" id="grade1"
                                                                   name="n[grade]" value="0" checked  <?php if($row1['grade']==0) echo 'checked' ?>>
                                                            <label class="custom-control-label" for="grade1">No</label>
                                                        </div>
                                                        <div class="custom-control custom-radio" style="display: inline">
                                                            <input type="radio" class="custom-control-input grade" id="grade2"
                                                                   name="n[grade]" value="1"  <?php if($row1['grade']==1) echo 'checked' ?>>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group" <?php if($row1['fieldtype']==18) { ?> style="display: none" <?php } ?>>
                                                        <label id="question_label" for="title"><?php if($row1['grade']==0) { echo 'Question';} else { echo 'Grade';} ?></label>
                                                        <input type="text" id="question_title" class="form-control ques" name="n[question]" placeholder="<?php if($row1['grade']==0) { echo 'Title';} else { echo 'Grade';} ?>" required="" value="<?php echo $row1['question']?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 noc_divs <?php if($row1['noc_flag']==1) { ?> showNoc <?php } ?>">
                                                ...
                                                <div class="form-group">
                                                    <select name="n[user_type]"  class="form-control  <?php if($row1['grade']==1) { ?> abc <?php } ?>">
                                                        <option value='' selected disabled>-- Select --</option>
                                                        <option value="user"  <?php if($row1['user_type']=='user') echo 'selected';?>>User</option>
                                                        <option value="spouse" <?php if($row1['user_type']=='spouse') echo 'selected';?>>Spouse</option>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio" style="display: inline">
                                                        <input type="radio" class="custom-control-input relate" id="rel1"
                                                               name="n[relate]" value="0" <?php if ($row1['relate'] == 0) {
                                                            echo 'checked';
                                                        } ?>>
                                                    ...
                                                    <div class="custom-control custom-radio" style="display: inline">
                                                        <input type="radio" class="custom-control-input relate" id="rel2"
                                                               name="n[relate]" value="1" <?php if ($row1['relate'] == 1) {
                                                            echo 'checked';
                                                        } ?>>
                                            ...
                                            <div class="col-sm-6 relQues2" <?php if ($row1['relate'] != 1) { ?> style="display: none;" <?php } ?>>
                                                <div class="form-group">
                                                    ...
                                                    <div id="mQues1" <?php if ($row1['relate'] == 1 && $row1['rel_qtype']=='s_question') { ?> style="display: none;" <?php } ?>>
                                                        <select name="qqid" class="form-control selectBox"
                                                                required id="">
                                                            <option value="" selected disabled>-- Select --</option>
                                                            <?php
                                                            foreach ($quesArr as $k => $v) {
                                                    ...
                                                    <div id="sQues1" <?php if ($row1['relate'] == 1 && $row1['rel_qtype']=='m_question') { ?> style="display: none;" <?php } ?>>
                                                        <select name="ssid" class="form-control selectBox"
                                                                id="" required>
                                                            <option value="" selected disabled>-- Select --</option>
                                                            <?php
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary waves-effect waves-light" id="AddLoader">Duplicate Question/Condtion</button>
        ...
        submitHandler: function () {
            ...
            $.ajax( {
                ...
                success: function ( data ) {
                    ...
                    $( "#AddLoader" ).html( 'Duplicate Question/Condition' );
                    $('#AddLoader').attr('disabled',false)

                    $( "div.prompt" ).show();
                    if ( data.Success === 'true' ) {
                        window.location.assign( "/admin/subques?id=<?php echo $_GET['qid']; ?>" );
                    } else {
                        $( window ).scrollTop( 0 );
