                            ...
                            <div class="card-body">
                                ...
                                if(isset($_GET['method']))
                                {
                                    ...
                                    <form method="post" id="validateForm2">
                                        <input type="hidden" name="n[question_id]" value="<?php echo $_GET['nqid'] ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control selectBox" name="s[casetype]" id="casetype" required onchange="changeOption()">
                                                        ...
                                                        <option value="movegroup" <?php if($row2['casetype']=='movegroup') echo 'selected';?>>Move to a Group with New Conditon</option>
                                                ...
                                                <div class="col-sm-6 operator" >
                                                    <div class="form-group">
                                                        ...
                                                        <select name="n[group_operator]" class="form-control" required>
                                                            <option value="=" <?php if($row2['group_operator']=='=') echo 'selected';?>>=</option>
                                                            <option value="!=" <?php if($row2['group_operator']=='!=') echo 'selected';?>>=</option>
                                                            <option value="<" <?php if($row2['group_operator']=='<') echo 'selected';?>>&lt;</option>
                                                            <option value=">" <?php if($row2['group_operator']=='>') echo 'selected';?>>&gt;</option>
                                                            <option value="<=" <?php if($row2['group_operator']=='<=') echo 'selected';?>>&lt;=</option>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="n[existing_qid]" class="form-control" required="">
                                                            <option value="" selected disabled>-- Select --</option>
                                                            <?php
                                                            foreach($quesArr as $k=>$v)
                                                            {
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary waves-effect waves-light" id="AddLoader">Duplicate Question/Condition</button>
                                        ...
                                        while ( $Row = mysqli_fetch_assoc( $getQuery ) ) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if($c=='subquestion' || $c=='existing' || $c=='multicondition')
                                                    {
                                                        echo $Row['question'];
                                                    }
                                                ...
                                                <td>
                                                    ...
                                                    <a href="?method=duplicate&id=<?php echo $Row['id']; ?>&qid=<?php echo $Row['question_id'] ?>&nqid=<?php echo $_GET['nqid'] ?>"  class="btn btn-sm btn-primary waves-effect waves-light"><i class="far fa-edit"></i></a>
...
<script>
    ...
    $( '#validateForm2' ).validate( {
        submitHandler: function () {
            ...
            $.ajax( {
                dataType: 'json',
                url: "ajax.php?h=duplicateSubQuestion",
                type: 'POST',
    ...
    $('.groupSelect').change(function () {
        ...
        if(c=='movegroup')
        {
            ...
            $('#groupQuest').html('')
            $('#groupQuest').html('<option value="" disabled selected>--Select--</option>')
