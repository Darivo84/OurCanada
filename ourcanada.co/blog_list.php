...
<div class="row">
            ...
            echo getContentMedia('image',$row['content_thumbnail'],true);
                  ...
                  <div class="post-entry-content" >
                    ...
                    <span class="jl_post_meta"><span class="jl_author_img_w"><img src="<?= $cms_url ?>assets/img/favicon.jpg" width="30" height="30" alt="Anna Nikova" class="avatar avatar-30 wp-user-avatar wp-user-avatar-30 alignnone photo" /><a style="cursor:pointer" onclick="return false" rel="author">
                      <?php
                      $query = "SELECT * FROM `users` WHERE id={$row['creator_id']}";
                      $fetch = mysqli_fetch_assoc(mysqli_query($conn, $query));
                      
                      if($row['created_by'] == 0){
                        // $fetch['username'] = $fetch['firstname'].' '.$fetch['lastname'];
              ...
              <?php if(mysqli_num_rows($result) < 1){
                ...
                <br>
              <?php }?>
             <!-- <div class="jl-loadmore-btn-w"><a href="#" class="jl_btn_load">Load more</a> </div> -->
              <!--<div class="jl-loadmore-btn-w"><a href="#" class="jl_btn_load">Load more</a>
                              </div>--> 
            </div>
