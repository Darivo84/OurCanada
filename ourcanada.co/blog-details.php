...
$moderator_rows=mysqli_num_rows($moderator);
...
if(empty(getCurLang($langURL,true)) || getCurLang($langURL,true) == 'english'){
    $blog_select = mysqli_query( $conn, "SELECT * FROM `".$blog_table."` WHERE slug='$blog_slug'" );
}else{
...
$querycount1="SELECT count(id) as count FROM `".$blog_table."`";
...
$prev = mysqli_query( $conn, "SELECT title,slug,id FROM `".$blog_table."` ORDER BY RAND() ORDER BY id DESC LIMIT 1" );
$prevpost= mysqli_fetch_assoc( $prev );
$next = mysqli_query( $conn, "SELECT title,slug,id FROM `".$blog_table."` WHERE id != ".$blog_content['id']." && status = 1  ORDER BY RAND() LIMIT 1" );
...
<head>
    ...
    {
        ?>
        <link rel="canonical" href="https://ourcanada<?php echo $ext ?>/community/blog-details" />
    ...
    <!-- Title-->
    <title><?= $allLabelsArray[693] ?></title>
    <!-- Favicon-->
...
<div class="options_layout_wrapper jl_none_box_styles jl_border_radiuss">
    <div class="options_layout_container full_layout_enable_front">
        ...
        <?php if ($blog_content['type']=='simpleblog' || $blog_content['type'] == 'pdf-blog'): ?>
                                ...
                                <div class="post-2808 post type-post status-publish format-standard has-post-thumbnail hentry category-business tag-gaming tag-morning tag-relaxing" id="post-2808">
                                    <div class="single_section_content box blog_large_post_style">
                                        <div class="jl_single_style2">
                                            <div class="single_post_entry_content single_bellow_left_align jl_top_single_title jl_top_title_feature"> <span class="meta-category-small" style="z-index: 999; display: block !important;">
									          ...
									          <?php foreach ($tags as $key => $value):
                                                ...
                                                <span class="single-post-meta-wrapper"><span class="post-author"><span><img src="<?php echo $url?>assets/img/favicon.jpg" width="50" height="50" alt="Admin" class="avatar avatar-50 wp-user-avatar wp-user-avatar-50 alignnone photo" />
                                                            <a href="<?php if($author_row['id'] != 0){echo cleanURL('user/'.$author_row['id']);}else{echo '';} ?>" rel="author"><?php echo $author; ?></a>
                                        ...
                                        <div class="post_content" style="margin-top: 20px;">
                                            ...
                                            <?php  if($blog_content['type'] == 'pdf-blog'){ ?>
                                        ...
                                        <div class="single_post_share_wrapper">
                                            ...
                                            <ul class="single_post_share_icon_post">
                                                <li class="single_post_share_facebook"><a href="https://www.facebook.com/sharer/sharer.php?u=<?= $cms_url.'blog/'.$blog_content['slug'] ?>" target="_blank"><i class="fa fa-facebook"></i></a>
                                                </li>
                                        ...
                                        if(!empty($nextpost["title"]) && $nextpost['id']!==$blog_content['id']){
                                            ...
                                            <div class="single_post_arrow_content"> <a href="<?php echo cleanURL('blog/'.$nextpost['slug']) ?>" id="nextpost"><?php echo displayTitle($nextpost["title"],50);?><span class="jl_post_nav_left"> <?= $allLabelsArray[666] ?></span></a> </div>
                                            </div><?php }?>
                                        <!--										<div class="auth">-->
                                        ...
                                        <div id="respond" class="comment-respond">
                                            ...
                                            <div class="comment-area">
                                                <div class="content_title">
                                                    ...
                                                    <h5 class="com_count">(0) <?= $allLabelsArray[668] ?></h5>
                                                </div>
                                            ...
                                            <h3 id="reply-title" class="comment-reply-title"><?php echo $allLabelsArray[669] ?> <small><a rel="nofollow" id="cancel-comment-reply-link" href="#" style="display:none;"><?= $allLabelsArray[671] ?></a></small></h3>
                                            <form id="commentform" class="comment-form">
                                                <p class="comment-notes"><span id="email-notes"><?php echo $allLabelsArray[670] ?> </span>
                                                </p>
                                                <p class="comment-form-comment">
                                                    <textarea maxlength="1000" class="u-full-width" id="comment" name="comment" cols="45" rows="8" aria-required="true" placeholder="<?php echo $allLabelsArray[672] ?>" required></textarea>
                                                ...
                                                <p class="form-submit">
                                                    <input type="submit" id="submit" class="submit" value="<?php echo $allLabelsArray[728] ?>">
                                                </p>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="post-2808 post type-post status-publish format-standard has-post-thumbnail hentry category-business tag-gaming tag-morning tag-relaxing" id="post-2808">
                                    <div class="single_section_content box blog_large_post_style">
                                        ...
                                        <div id="respond" class="comment-respond">
                                            ...
                                            <h3 id="reply-title" class="comment-reply-title"><?php echo $allLabelsArray[669] ?> <small><a rel="nofollow" id="cancel-comment-reply-link" href="#" style="display:none;"><?php echo $allLabelsArray[671] ?></a></small></h3>
                                            <form id="commentform" class="comment-form">
                                                <p class="comment-notes"><span id="email-notes"><?php echo $allLabelsArray[670] ?></span>
                                                </p>
                                                <p class="comment-form-comment">
        ...
        <!-- if of video-blog -->
        <?php if ($blog_content['type']=='video-blog'): ?>
        <div class="jl_home_section">
            <div class="container">
                <div class="row">
                    <div class="col-md-8  loop-large-post" id="content">
            ...
            <?php if ($blog_content['type']=='video-image-blog'): ?>
            <div class="jl_home_section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8  loop-large-post" id="content">
            ...
            <div class="modal-content">
                <form>
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><?php echo $allLabelsArray[676] ?></h4>
                    </div>
                    <div class="modal-body">
                        <div class="error_msg"></div>
                        <input type="hidden" hidden name="content_id">
                        <input type="hidden" hidden name="comment_id">
                        <textarea required name="reply_comment" placeholder="<?php echo $allLabelsArray[682] ?>" class="form-control"></textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" data-dismiss="modal"><?php echo $allLabelsArray[728] ?></button>
                        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="closeReplyForm();"><?php echo $allLabelsArray[174] ?></button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content">
                <div class="modal-header" style="background: #8d633a;">
                    <h5 class="modal-title" id="exampleModalLabel" style="color: #fff; text-align: center;"><?php echo $allLabelsArray[11] ?></h5>
                ...
                <div class="modal-body">
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="form-group" style="position: relative;">
                            <label><?php echo $allLabelsArray[173] ?></label>
                            <i class="fa fa-envelope inputIcon" ></i>
                            <input type="email" placeholder="abc@gmail.com" name="email" class="form-control loginInput" required style="padding-left: 35px;">
                        </div>
                        <div class="form-group" style="position: relative;">
                            <label><?php echo $allLabelsArray[146] ?></label>
                            <i class="fa fa-key inputIcon" ></i>
                            <i class="fa fa-eye-slash eyeIcon" onclick="show_hide($(this));" ></i>
                            <input type="password" placeholder="<?php echo $allLabelsArray[146] ?>" name="password" class="form-control loginInput" required style="padding-left: 35px;">
                        </div>
                        <div style="position: relative;" class="form-group text-right">
                            <a href="<?= $cms_url ?>forgot-password<?= $langURL ?>" style="font-weight: bold;color: #8d633a;"><?php echo $allLabelsArray[220] ?></a>
                        </div>
                    </div>
                </div>
                <div class="modal-footer" style="text-align: center; border: 0;">
                    <button type="submit" class="btn btn-primary" style="width: 200px; background: #8d633a; border: 0; margin-bottom: 5px;"><?php echo $allLabelsArray[11] ?></button>
                    <br>
                    <?php echo $allLabelsArray[675] ?><a href="<?= $cms_url ?>register"><b style="color: #8d633a; margin-left: 10px;"><?php echo $allLabelsArray[203] ?></b></a>
    ...
    <div class="modal login_like" tabindex="-1" role="dialog" style="display: none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo $allLabelsArray[563] ?></h5>
                ...
                <div class="modal-footer">
                    <!-- <button type="button" class="btn btn-primary">Save changes</button> -->
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="$('.com_not').hide();"><?php echo $allLabelsArray[174] ?></button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="form-group" style="position: relative;">
                            ...
                            <i class="fa fa-key inputIcon" ></i>
                            <i class="fa fa-eye-slash eyeIcon" onclick="show_hide($(this));"></i>
                            <input type="password" placeholder="<?= $allLabelsArray[146] ?>" name="password" class="form-control loginInput" required style="padding-left: 35px;">
                        </div>
                        <div style="position: relative;" class="form-group text-right">
                            <a href="<?= $cms_url ?>forgot-password<?= $langURL ?>" style="font-weight: bold;color: #8d633a;"><?php echo $allLabelsArray[220] ?></a>
                        </div>
    ...
    <div class="snackbar main_snackbar">
        <div class="box" style="text-align: center; background: #fff; border-radius: 5px; box-shadow: 0px 0px 20px rgba(0,0,0,2); padding-bottom: 15px;">
            <div style="width: 100%; background: #855b32; line-height: 40px;border-top-left-radius: 5px;border-top-right-radius: 5px; color: #fff;font-size: 18px;font-weight: bold;"><?php echo $allLabelsArray[176] ?></div>
            <p class="comment_del_modal"><i class="fa fa-trash" style="margin-right: 10px;"></i><?php echo $allLabelsArray[677] ?></p>
            <button class="btn btn-danger" style="marpxn-right: 10px; border: 0;"><i class="fa fa-spinner fa-spin" style="margin-right: 10px; display: none;"></i><?php echo $allLabelsArray[40] ?></button>
            <button class="btn btn-warning" style="border: 0; background: #855b32;"><?php echo $allLabelsArray[41] ?></button>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: "<?= $cms_url ?>ajax.php?h=AddView&lang=<?php echo getCurLang($langURL,true) ?>",
                data: {content_id: <?= $id ?>},
                dataType: "json",
            ...
            $.ajax({
                type: "POST",
                url: "<?= $cms_url ?>ajax.php?h=GetLikes&lang=<?php echo getCurLang($langURL,true) ?>",
                data: {content_id: <?= $id ?>},
                dataType: "json",
                success: function(res){
        ...
        function addLike(sel){
            ...
            $.ajax({
                type: "POST",
                url: "<?= $cms_url ?>ajax.php?h=AddLike&lang=<?php echo getCurLang($langURL,true) ?>",
                data: {content_id: <?= $id ?>},
                dataType: "json",
                success: function(res){
                    console.log(res)
            ...
            $("#loginModelLike form").validate({
                ...
                submitHandler: function(form){
                    $.ajax({
                        type: "POST",
                        url: "<?= $cms_url ?>ajax.php?h=login&lang=<?php echo getCurLang($langURL,true) ?>",
        ...
        $("#commentform").validate({
            ...
            submitHandler: function(form){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= $cms_url ?>ajax.php?h=comments&c_id=<?= $id ?>&lang=<?php echo getCurLang($langURL,true) ?>",
                    ...
                    success: function(res){
                        ...
                        if(res.success){
                            ...
                            $("#snackbarMSG p").html("<?php echo $allLabelsArray[700] ?>");
                            setTimeout(function(){
                                $("#snackbarMSG").slideUp();
                            },3000);
                ...
                $("#loginModel form").validate({
                    ...
                    submitHandler: function(form){
                        $.ajax({
                            type: "POST",
                            url: "<?= $cms_url ?>ajax.php?h=model_login&lang=<?php echo getCurLang($langURL,true) ?>",
        ...
        function getComments(){
            $.ajax({
                type: "POST",
                url: "<?= $cms_url ?>ajax.php?h=getComments&lang=<?php echo getCurLang($langURL,true) ?>",
                data: {id:<?= $id ?>},
                dataType: "json",
                success: function(res){
                    // console.log(res)
                    ...
                    for (var i = 0; i < res.comments.length; i++) {
                        ...
                        html += '<div class="comment_user">'+
                            ...
                            '<button class="btn btn-success editCommentBtn" comment_id="'+res.comments[i].c_id+'" onclick="postComment($(this));" ><i class="fa fa-spin fa-spinner" style="display: none;"></i> Post</button>'+
                        ...
                        if(res.comments[i].replies && res.comments[i].status == 1){
                            for (var j = 0; j < res.comments[i].replies.length; j++) {
                                ...
                                html += '<div class="comment_user">'+
                                    ...
                                    '<button class="btn btn-success" comment_id="'+res.comments[i].replies[j].c_id+'"><i class="fa fa-spin fa-spinner" style="display: none;"></i> <?= $allLabelsArray[679] ?></button>'+
        ...
        function EditComment(id,sel){
            ...
            $("#edit_reply_id"+id).children("button[comment_id="+id+"]").click(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= $cms_url ?>ajax.php?h=update_comment_blog&lang=<?php echo getCurLang($langURL,true) ?>",
        ...
        $(".main_snackbar .btn-danger").click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?= $cms_url ?>ajax.php?h=delete_my_comment_blog&lang=<?php echo getCurLang($langURL,true) ?>",
                data: {id:globalDelID},
                beforeSend: function(){
                    sel.children("i").show();
                },success: function(res){
        ...
        function reply_EditComment(id,sel){
            ...
            $("#edit_r_reply_id"+id).children("button[comment_id="+id+"]").click(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= $cms_url ?>ajax.php?h=reply_update_comment_blog&lang=<?php echo getCurLang($langURL,true) ?>",
        ...
        $(".snackbar.reply .btn-danger").click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?= $cms_url ?>ajax.php?h=reply_delete_my_comment_blog&lang=<?php echo getCurLang($langURL,true) ?>",
        ...
        function postComment(sel){
            ...
            if(comment != ""){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= $cms_url ?>ajax.php?h=CommentReply&lang=<?php echo getCurLang($langURL,true) ?>",
                ...
                $("#loginModel form").validate({
                    ...
                    submitHandler: function(form){
                        $.ajax({
                            type: "POST",
                            url: "<?= $cms_url ?>ajax.php?h=model_login_reply&lang=<?php echo getCurLang($langURL,true) ?>",
                            data: $("#loginModel form").serialize(),
                            dataType: "json",
                            success: function(res){
                                console.log(res)
                                if(res.login_err){
                                    ...
                                    $("#loginModel .log_err span").text("<?php echo $allLabelsArray[152] ?>");
        ...
        function getCommentCount(){
            $.ajax({
                type: "POST",
                url: "<?= $cms_url ?>ajax.php?h=CommentsCount&lang=<?php echo getCurLang($langURL,true) ?>",
                data: {content_id:<?= $id ?>},
                dataType: "json",
                success: function(res){
                    if(res.total==0){
                        $(".com_count").text("<?php echo $allLabelsArray[729] ?>")
                    }else{
                        $(".com_count").text("("+res.total+") <?php echo $allLabelsArray[668] ?>")
                    }
    ...
    <script type="text/javascript">
        function convertTZ(date1, tzString = '') {
            tzString = Intl.DateTimeFormat().resolvedOptions().timeZone;
            var date = new Date((typeof date1 === "string" ? new Date(date1) : date1).toLocaleString("en-US", {timeZone: tzString}));
            var new_date = date.toString();
            var newdate = new_date.split(":");
            ...
            var hours2 = hours%12;
            var finalTime = "Time  - " + hours2 + ":" + minutes;
            return newdate[0].slice(0,-2)+" "+hours2 + ":" + minutes + " "+ AmOrPm;
        }
