...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    if($environment==true)
    {
        ...
        <meta name="description" content="<?= $allLabelsArray[777] ?>">
        <meta name="keywords" content="<?= $allLabelsArray[776] ?>">
        <link rel="canonical" href="https://ourcanada<?php echo $ext ?>/community/blogs" />
    ...
    <meta property="og:description" content="<?= $allLabelsArray[777] ?>" />
    <meta property="og:image" content="https://ourcanada<?php echo $ext ?>/community/assets/images/blog-banner2.webp" />
    <meta property="og:url" content="<?= "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" ?>" />
<!-- Title-->
<title><?= $allLabelsArray[518] ?></title>
<!-- Favicon-->
    ...
    <div class="jl_home_section jl_car_h5"> 
      ...
      <div class="jelly_homepage_builder jl_car_home jl_nonav_margin">
        <div class="homepage_builder_title">
          <h2> <?= $allLabelsArray[504] ?> </h2>
          <span class="jl_hsubt" style="margin-bottom: 30px;"><?= $allLabelsArray[794] ?></span> 
        </div>
          ...
          <div class="jl_wrapper_row jl-post-block-108832">
            ...
            echo getContentMedia('image',$row['content_thumbnail'],true);
                  ...
                  <div class="post-entry-content" >
                    <h3 class="image-post-title"><a class="text-doted" href="<?= cleanURL('blog/'.$row['slug']) ?>" title="<?= $row['title'] ?>"><?php echo $row['title'] ?></a></h3>
             ...
             <div class="container-fluid" style="text-align: right; padding: 0;">
                ...
                <?php
                $query1 = "SELECT COUNT(*) as total FROM `".$blog_table."` WHERE ";
                if(isset($_POST['value']) && count($_POST['value']) > 0){
                  $que = '';
                  for ($i=0; $i < count($_POST['value']); $i++) { 
                    $que .= " FIND_IN_SET('".$_POST['value'][$i]."',category) && status = 1 ||";
				...
				echo get_pagination_links(1,$total_pages); ?>
            ...
            <div class="row">
              <div class="col-md-12 main_title_col">
                <div class="jl_cat_mid_title">
                  ...
                  <a class="btn btn-md" href="<?= $cms_url ?>create-blog<?= getCurLang($langURL) ?>" style="border-radius: 15px; background: #FE0000; color: white; display: inline-block; margin-top: 15px"><?= $allLabelsArray[507] ?></a>
                </div>
              </div>
            </div>
          </div>
...
<script>
  ...
  $(".search-content input").on("keyup",function(){
    ...
    $.ajax({
        type: "POST",
        url: "<?= $main_app ?>blog_list.php?lang=<?= getCurLang($langURL,true) ?>",
  ...
  function page(sel,active){
    var sel = sel;
      ...
      $.ajax({
        type: "POST",
        url: "<?= $main_app ?>blog_list.php?lang=<?= str_replace('/', '', $langURL) ?>",
