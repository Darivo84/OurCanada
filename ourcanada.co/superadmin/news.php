            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Review News</h4>
                                    ...
                                    <div class="page-title-right">
                                      ...
                                      <option <?php if(str_replace('_', '', $cur_lang) == "arabic"){echo "selected";} ?> value="arabic">Arabic News</option>
                                        ...
                                        <!-- <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Review News</li>
                                        </ol> -->
                                    </div>
						...
						$newsID=$_GET['n_id'];
	$query = "SELECT * FROM news_content".$cur_lang." where id='".$newsID."' && created_by = 0 ORDER BY id DESC";
          ...
          <div class="prompt"></div>
            ...
            <input type="hidden" name="table" value="news_content">
			...
			<a type="button" href="news.php" class="btn btn-light">Cancel</a>
						</div>
					  </div>
					</form>                
				  </div>
...
$query ="SELECT * FROM news_content".$cur_lang." WHERE created_by = 0 ORDER BY id DESC";  
          ...
          while ( $row = mysqli_fetch_array( $result ) ) {
			 ?>
                                             ...
                                             <td>
                                              ...
                                              <a type="button" href="<?= $currentTheme.'community/news/'.$row['slug'].$view_lang ?>" class="btn btn-icon btn-info table-button"><i class="fas fa-info" ></i></a>
                                              ...
                                              <a href="update-user-content.php?id=<?= $row['id'] ?>&type=news&lang=<?= str_replace('_', '', $cur_lang) ?>" id="editbtn" type="button" class="btn btn-icon btn-success table-button"><i class="fas fa-pencil-alt" ></i></a>
...
function getContent(value){
        if(value != ""){
            window.location.href = "<?php echo $currentTheme ?>superadmin/news?lang="+value;
        }else{
            window.location.href = "<?php echo $currentTheme ?>superadmin/news";
        }
    }
    ...
    if(id != "" && id > 0){
      if(val != ""){
        $.ajax({
          ...
          data:{id:id,user_id:user_id,val:val,points:points,table:"news_content"},
            dataType: "json",
          beforeSend: function(){
            sel.children("i").show();
...
$(document).ready( function () {
  var cid=<?php echo $newsID ?>;
		 $.ajax( {
                ...
                type: 'POST',
                data: {id : cid,table:"news_content"},
                success: function ( data ) {
                    if ( data.Success == 'true' ) 
					{
