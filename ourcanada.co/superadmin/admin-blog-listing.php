    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="mb-0 font-size-18">Blog Listing</h4>
                ...
                $query = "SELECT * FROM `blog_content".$cur_lang."` WHERE created_by = 1";
                                            ...
                                            <?php while ($fetch_row = mysqli_fetch_assoc($result)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                                ...
                                                                <a class="text-info" target="_new" href="<?=$currentTheme.'community/blog/'.$fetch_row['slug'].$view_lang ?>"><i class="fa fa-info"></i>&nbsp;View&nbsp;&nbsp;</a>
                                                        
                                                        <a
                                                                href="update-content?id=<?php echo $fetch_row['id']; ?>&type=blog<?php if(isset($_GET['lang']) && !empty($_GET['lang']))echo'&lang='.$_GET['lang']; ?>"
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body"> 
                        ...
                        <br>
                        Are you sure, you wan't to delete this blog?
...
<script type="text/javascript">
    function getContent(value){
        if(value != ""){
            window.location.href = "<?php echo $currentTheme ?>superadmin/admin-blog-listing?lang="+value;
        }else{
            window.location.href = "<?php echo $currentTheme ?>superadmin/admin-blog-listing";
        }
    }
