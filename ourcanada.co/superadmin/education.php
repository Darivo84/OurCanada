                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Education Options</h4>
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Multi Lingual</a></li>
                                    <li class="breadcrumb-item active">Education Options</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control ques" name="n[name]" placeholder="English" required="">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control ques" name="n[name_french]" placeholder="Francais/French" >
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control ques" name="n[name_spanish]" placeholder="Spanish" >
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control ques" name="n[name_urdu]" placeholder="Urdu" >
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control ques" name="n[name_chinese]" placeholder="Chinese" >
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control ques" name="n[name_hindi]" placeholder="Hindi" >
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control ques" name="n[name_punjabi]" placeholder="Punjabi" >
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control ques" name="n[name_arabic]" placeholder="Arabic" >
                                ...
                                <?php }
                                    ...
                                    $getID = $_GET['id'];
                                    $getLabels = mysqli_query($conn , "SELECT * FROM education WHERE id = '$getID'");
                                    ...
                                    <form method="post" id="EvalidateForm">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="title">English</label>
                                                    <input type="text" class="form-control ques" name="n[name]" placeholder="English" value="<?php echo $fetchLabels['name']; ?>" required="">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="title">Francais/French</label>
                                                    <input type="text" class="form-control ques" name="n[name_french]" placeholder="Francais/French" value="<?php echo $fetchLabels['name_french']; ?>">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="title">Spanish</label>
                                                    <input type="text" class="form-control ques" name="n[name_spanish]" placeholder="Spanish" value="<?php echo $fetchLabels['name_spanish']; ?>">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="title">Urdu</label>
                                                    <input type="text" class="form-control ques" name="n[name_urdu]" placeholder="Urdu" value="<?php echo $fetchLabels['name_urdu']; ?>">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="title">Chinese</label>
                                                    <input type="text" class="form-control ques" name="n[name_chinese]" placeholder="Chinese" value="<?php echo $fetchLabels['name_chinese']; ?>">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="title">Hindi</label>
                                                    <input type="text" class="form-control ques" name="n[name_hindi]" placeholder="Hindi" value="<?php echo $fetchLabels['name_hindi']; ?>">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="title">Punjabi</label>
                                                    <input type="text" class="form-control ques" name="n[name_punjabi]" placeholder="Punjabi" value="<?php echo $fetchLabels['name_punjabi']; ?>">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="title">Arabic</label>
                                                    <input type="text" class="form-control ques" name="n[name_arabic]" placeholder="Arabic" value="<?php echo $fetchLabels['name_arabic']; ?>">
...
<script>
    ...
    $( '#EvalidateForm' ).validate( {
        submitHandler: function () {
            ...
            $.ajax( {
                dataType: 'json',
                url: "ajax.php?h=updateEducation",
                type: 'POST',
            ...
            $.ajax( {
                ...
                success: function ( data ) {
                    ...
                    if ( data.Success === 'true' ) {
                        ...
                        $( '.prompt' ).html( '<div class="alert alert-success" style="text-align:left !important"><i class="fas fa-check" style="margin-right:10px;"></i>' + data.Msg + '</div>' );
                        setTimeout( function () {
                            window.location.assign('/superadmin/education')
                        }, 2000 );
                    } else {
                        $( window ).scrollTop( 0 );
                        $( '.prompt' ).html( '<div class="alert alert-danger" style="text-align:left !important"><i class="fas fa-times" style="margin-right:10px;"></i>' + data.Msg + '</div>' );
    ...
    $("#delLoader").on('click',function(){
        ...
        $.ajax( {
            dataType: 'json',
            url: "ajax.php?h=deleteEducation",
            type: 'POST',
            data: {'id' : id},
            success: function ( data ) {
