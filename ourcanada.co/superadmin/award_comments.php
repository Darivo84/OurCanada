            ...
            <div class="container-fluid">
                ...
                <?php

                    {
                        ...
                        $select=mysqli_query($conn,"select n.title,u.firstname,u.lastname,u.profileimg,u.gender,c.* from awards_comments as c join users as u on c.user_id=u.id join nominations as n on c.item_id=n.id where c.item_type='award' ORDER BY c.id DESC");
    ...
    <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold mt-2" id="title">Full Comment</h6>
