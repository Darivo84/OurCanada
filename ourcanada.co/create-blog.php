...
<meta name="keywords" content="">
    ...
    {
        ?>
        <link rel="canonical" href="https://ourcanada<?php echo $ext ?>/community/create-blog" />

        <?php
    }
    ?>
<!-- Title-->
<title><?= $allLabelsArray[513] ?></title>
<!-- Favicon-->
...
<div class="options_layout_wrapper jl_none_box_styles jl_border_radiuss">
  <div class="options_layout_container full_layout_enable_front"> 
    ...
    <!-- end header -->
	  ...
	  <div class="col-sm-12">
		  	<h3 class="blogType"><?= $allLabelsArray[485] ?></h3>
			<div id="socialcountplus-2" class="widget widget_socialcountplus">
			<div class="social-count-plus">
			  <ul class="default">
				<li class="count-facebook" onClick="changeType('simpleblog')">
				  <a class="icon" ><i class="fa fa-file"></i></a><span class="items"><span class="label"><?= $allLabelsArray[486] ?></span></span>
				</li>
				<li class="count-facebook" onClick="changeType('pdf-blog')">
				  <a class="icon" ><i class="fa fa-file"></i></a><span class="items"><span class="label"><?= $allLabelsArray[808] ?></span></span>
				</li>
				<li class="count-facebook" onClick="changeType('video-blog')">
				  <a class="icon" ><i class="fa fa-youtube"></i></a><span class="items"><span class="label"><?= $allLabelsArray[487] ?></span></span>
				</li>
				<li class="count-facebook" onClick="changeType('image-slider-blog')">
				  <a class="icon" ><i class="fa fa-image"></i></a><span class="items"><span class="label"><?= $allLabelsArray[488] ?></span></span>
				</li>
				<li class="count-facebook" onClick="changeType('video-image-blog')">
				  <a class="icon" ><i class="fa fa-images"></i></a><span class="items"><span class="label"><?= $allLabelsArray[489] ?></span></span>
				</li>
...
<input type="hidden" name="getType" hidden value="blog">
...
<script>
  ...
  $(".count-facebook").click(function(){
    $(".blogType").text("<?= $allLabelsArray[715] ?>");
